(function () {
    ...
    template.innerHTML = `
        <div id="my-modal" draggable="true" style="width:100%;height:100%">
            ...
            <iframe src="https://i18n-1257745828.cos.ap-shanghai.myqcloud.com/sap/modal/modal.html?t=12345123126" style="margin-left:2%;width:96%;height:100%;border:none;padding-top: 25px"></iframe>
    ...
    customElements.define("com-sap-sample-modal", modalBox);
})();